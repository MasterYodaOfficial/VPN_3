...
Revision ID: dc24cc2b4f17
Revises: 
Create Date: 2025-07-20 13:52:54.863418
...
def upgrade() -> None:
    ...
    sa.Column('method', sa.Enum('yookassa', 'crypto', name='paymentmethod'), nullable=False),
